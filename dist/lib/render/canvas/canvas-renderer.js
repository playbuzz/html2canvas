...
var image_filter_1 = require("../image-filter");
var font_color_gradient_1 = require("../font-color-gradient");
...
var CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderTextNode = function (text, styles, container) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, font, fontFamily, fontSize, fillStyle, backgroundImage, _b, x, y, width, height, _c, lineLength, x0, x1, y0, y1, gradient_2, gradient_3, backgroundImage, _d, left, top_1, width, height, position, x, y, rx, radialGradient_1;
            var _this = this;
            return __generator(this, function (_e) {
                _a = this.createFontStyle(styles), font = _a[0], fontFamily = _a[1], fontSize = _a[2];
                this.ctx.font = font;
                fillStyle = color_1.asString(styles.color);
                if (font_color_gradient_1.isFontColorGradient(styles)) {
                    if (image_1.isLinearGradient(styles.backgroundImage[0])) {
                        backgroundImage = styles.backgroundImage[0];
                        _b = background_1.calculateBackgroundRendering(container, 0, [null, null, null]), x = _b[1], y = _b[2], width = _b[3], height = _b[4];
                        ...
                        if (Math.round(Math.abs(x0)) === Math.round(Math.abs(x1))) {
                            gradient_2 = this.ctx.createLinearGradient(x, y0 + y, x, y1 + y);
                            ...
                            gradient_3 = this.ctx.createLinearGradient(x + x0, y, x + x1, y);
                            gradient_1.processColorStops(backgroundImage.stops, lineLength).forEach(function (colorStop) {
                                return gradient_3.addColorStop(colorStop.stop, color_1.asString(colorStop.color));
                            });
                            fillStyle = gradient_3;
                        }
                    }
                    else if (image_1.isRadialGradient(styles.backgroundImage[0])) {
                        backgroundImage = styles.backgroundImage[0];
                        _d = background_1.calculateBackgroundRendering(container, 0, [
                            null,
                            null,
                            null
                        ...
                        rx = gradient_1.calculateRadius(backgroundImage, x, y, width, height)[0];
                        if (rx > 0 && rx > 0) {
                ...
                text.textBounds.forEach(function (text) {
                    ...
                    if (styles.textStrokeWidth &&
                        ...
                        _this.ctx.strokeStyle = color_1.asString(styles.textStrokeColor);
                        _this.ctx.lineWidth = length_percentage_1.getAbsoluteValue(styles.textStrokeWidth, text.bounds.width);
    ...
    CanvasRenderer.prototype.renderReplacedElement = function (container, curves, image) {
        if (image && container.intrinsicWidth > 0 && container.intrinsicHeight > 0) {
            ...
            this.ctx.save();
            this.ctx.clip();
            if (image_filter_1.isSupportedFilter(this.ctx) && container.styles.filterOriginal) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        if (!(container instanceof image_element_container_1.ImageElementContainer)) return [3 /*break*/, 10];
                        _b.label = 5;
                    case 5:
                        _b.trys.push([5, 9, , 10]);
                    ...
                    case 6:
                        image = _b.sent();
                        if (!(styles.filter && !image_filter_1.isSupportedFilter(this.ctx))) return [3 /*break*/, 8];
                        return [4 /*yield*/, image_filter_1.processImage(image, styles.filter)];
                    case 7:
                        _b.sent();
                        _b.label = 8;
                    case 8:
                    ...
                    case 10:
                        ...
                        if (!(container instanceof svg_element_container_1.SVGElementContainer)) return [3 /*break*/, 14];
                        _b.label = 11;
                    case 11:
                    ...
                    case 13:
                        ...
                        return [3 /*break*/, 14];
                    case 14:
                        if (!(container instanceof iframe_element_container_1.IFrameElementContainer && container.tree)) return [3 /*break*/, 16];
                    ...
                    case 16:
                        ...
                        if (!bitwise_1.contains(container.styles.display, 2048 /* LIST_ITEM */)) return [3 /*break*/, 22];
                        if (!(container.styles.listStyleImage !== null)) return [3 /*break*/, 21];
                        img = container.styles.listStyleImage;
                        if (!(img.type === image_1.CSSImageType.URL)) return [3 /*break*/, 20];
                        image = void 0;
                        url = img.url;
                        _b.label = 17;
                    case 17:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (font_color_gradient_1.isFontColorGradient(container.styles))
                            return [2 /*return*/, false];
                        _loop_1 = function (backgroundImage) {
                            var image, url, e_4, _a, path, x, y, width, height, pattern, _b, path, x, y, width, height, _c, lineLength, x0, x1, y0, y1, canvas, ctx, gradient_4, pattern, _d, path, left, top_2, width, height, position, x, y, _e, rx, ry, radialGradient_2, midX, midY, f, invF;
                                ...
                                switch (_f.label) {
                                    ...
                                    case 5:
                                        if (image_1.isLinearGradient(backgroundImage)) {
                                            ...
                                            gradient_1.processColorStops(backgroundImage.stops, lineLength).forEach(function (colorStop) {
                                                return gradient_4.addColorStop(colorStop.stop, color_1.asString(colorStop.color));
                                            });
                                            ...
                                            if (rx > 0 && rx > 0) {
                                                ...
                                                gradient_1.processColorStops(backgroundImage.stops, rx * 2).forEach(function (colorStop) {
                                                    return radialGradient_2.addColorStop(colorStop.stop, color_1.asString(colorStop.color));
                                                });
                                                this_1.path(path);
