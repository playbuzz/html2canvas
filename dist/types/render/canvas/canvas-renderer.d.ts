...
export declare class CanvasRenderer {
    ...
    renderTextNode(text: TextContainer, styles: CSSParsedDeclaration, container: ElementContainer): Promise<void>;
    ...
    renderBackgroundImage(container: ElementContainer): Promise<false | undefined>;
